...
![截屏2023-12-22 下午2.33.09](D:\typora\Golang_Engineer\typora-user-images\截屏2023-12-22 下午2.33.09.png)
...
![截屏2023-12-22 下午2.34.30](D:\typora\Golang_Engineer\typora-user-images\截屏2023-12-22 下午2.34.30.png)
...
![截屏2023-12-22 下午2.35.27](D:\typora\Golang_Engineer\typora-user-images\截屏2023-12-22 下午2.35.27.png)
...
这些专门的节点，就是所谓的 Route Reflector 节点，它们实际上扮演了“中间代理”的角色，从而把 BGP 连接的规模控制在 N 的数量级上。 此外，我在前面提到过，Flannel host-gw 模式最主要的限制，就是要求集群宿主机之间是二层连通的。而这个限制对于 Calico 来说，也同样存在。
...
而我们现在的需求，还是 Container 1 要访问 Container 4。 按照我们前面的讲述，Calico 会尝试在 Node 1 上添加如下所示的一条路由规则：
...
![截屏2023-12-22 下午2.36.28](D:\typora\Golang_Engineer\typora-user-images\截屏2023-12-22 下午2.36.28.png)
...
![截屏2023-12-22 下午2.37.12](D:\typora\Golang_Engineer\typora-user-images\截屏2023-12-22 下午2.37.12.png)
