...
![截屏2023-12-29 下午1.41.26](D:\typora\Golang_Engineer\typora-user-images\截屏2023-12-29 下午1.41.26.png)
...
![截屏2023-12-29 下午1.41.40](D:\typora\Golang_Engineer\typora-user-images\截屏2023-12-29 下午1.41.40.png)

而作为一个 CRI shim，containerd 对 CRI 的具体实现，又是怎样的呢？ 我们先来看一下 CRI 这个接口的定义。下面这幅示意图，就展示了 CRI 里主要的待实现接口。

![截屏2023-12-29 下午1.41.51](D:\typora\Golang_Engineer\typora-user-images\截屏2023-12-29 下午1.41.51.png)

具体地说，我们可以把 CRI 分为两组： 

第一组，是 RuntimeService。它提供的接口，主要是跟容器相关的操作。比如，创建和启动容器、删除容器、执行 exec 命令等等。 而
...
![截屏2023-12-29 下午1.42.00](D:\typora\Golang_Engineer\typora-user-images\截屏2023-12-29 下午1.42.00.png)
...
![截屏2023-12-29 下午1.42.00](D:\typora\Golang_Engineer\typora-user-images\截屏2023-12-29 下午1.42.00-1709297100768-56.png)
